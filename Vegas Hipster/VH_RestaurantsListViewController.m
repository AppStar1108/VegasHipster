//
//  VH_RestaurantsListViewController.m
//  Vegas Hipster
//
...
@interface VH_RestaurantsListViewController ()

@end

@implementation VH_RestaurantsListViewController
...
- (void)get_table_data {
	...
	NSString *query = [[NSString alloc] initWithFormat:@"SELECT rest_type_id, type FROM rest_type_db ORDER BY type ASC;"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    [self performSegueWithIdentifier:@"RestaurantSubListPushSegue" sender:self];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([[segue identifier] isEqualToString:@"RestaurantSubListPushSegue"]) {
        
        // Get reference to the destination view controller
        VH_RestaurantsSubListViewController *vc = [segue destinationViewController];
        ...
        [vc getRestaurantType:[[listArray objectAtIndex:selectedIndex] objectForKey:@"id"]];
    }
}
